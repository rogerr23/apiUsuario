...
public class CriarUsuarioRequestDto {
	...
	@Size(min = 8, max = 150, message = "Informe no minímo 8 e no máximo 150 caracteres.")
	...
	@Pattern(regexp = "^(?=.*[0-9])(?=.*[a-z])(?=.*[A-Z])(?=.*[@#$%^&+=])(?=\\S+$).{8,}$", message = "Informe a senha com letras minúsculas, maiúsculas, símbolos e pelo menos 8 caracteres.")
